...
export const setEditorThemeOnPreview = ({commit}, theme) => {
  commit(types.SET_CUR_EDITOR_THEME, theme)
}
...
export const uploadTheme = ({commit}, theme) => {
  return api.uploadTheme(theme).then((res) => {
    commit(types.UPLOAD_TO_SVN, res)
  })
}
